...
//  Project5
//
//  Created by Vishrut Vatsa on 11/22/20.
//
            ...
            if isOriginal(word: lowerAnswer) {
                if isReal(word: lowerAnswer) {
                    if lowerAnswer.count > 2 {
                        ...
                        showErrorMessage(errorTitle: "Too Short", errorMessage: "Your word is too short, try to make it atleast 4.")
                    }
                } else {
                    showErrorMessage(errorTitle: "Word not recognised", errorMessage: "You can't just make them up, you know that!")
                }
            } else {
