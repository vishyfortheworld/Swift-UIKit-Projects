...
//  Project2
//
//  Created by Vishrut Vatsa on 10/31/20.
//
...
//    challenge 2
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        if sender.tag == correctAnswer {
            ...
            // multiline messages can be enclosed in triple commas..see below
            
            message = """
                You picked: \(countries[correctAnswer].uppercased()) was: #\(correctAnswer + 1)
                Score: \(score)
                """
